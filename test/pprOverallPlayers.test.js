...
const seedPprOverall = require('../db/seed/fantasy-football-adp-rankings-ppr');

chai.use(chaiHttp);
const expect = chai.expect;

describe('Player List - PPR Overall', function() {
  ...
  beforeEach(function (){
    return Promise.all([
      PprOverall.insertMany(seedPprOverall)
    ]);
  });
  ...
  describe('GET /api/ppr/overall', function() {
